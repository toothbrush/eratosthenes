...
presented in Figures \ref{fig:bench-huy-put-p2} to \ref{fig:bench-laptop-get-p56}. 
...
synchronisation cost is hypothesised to be O($n$) (i.e. linearly increasing in
